...
alias d='dirs -v'
alias softeng='cd ~/wpi/2014-b-cs3733'
alias network='cd ~/wpi/2014-b-cs4516'
alias realtime='cd ~/wpi/2014-b-ece3849'
alias disnec='xrandr --output DP2 --off'
alias dm='dmesg --color=always --time-format iso'
alias dmf='dm --follow'
alias dmt='dm | tail'
alias drbe='cd ~/wpi/2014-a-rbe2001'
alias e='exit'
alias ennec='xrandr --output DP2 --mode 1280x1024 --right-of eDP1'
alias f='find'
